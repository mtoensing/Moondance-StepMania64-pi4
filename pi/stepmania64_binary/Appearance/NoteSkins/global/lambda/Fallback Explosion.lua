...
local t = Def.ActorFrame {
	...
	NOTESKIN:LoadActor( Var "Button", "Tap Explosion Dim" ) .. {
		...
		ProW5Command=NOTESKIN:GetMetricA("GhostArrowDim", "ProCommand");
		ProW4Command=NOTESKIN:GetMetricA("GhostArrowDim", "ProCommand");
		ProW3Command=NOTESKIN:GetMetricA("GhostArrowDim", "ProCommand");
		ProW2Command=NOTESKIN:GetMetricA("GhostArrowDim", "ProCommand");
		ProW1Command=NOTESKIN:GetMetricA("GhostArrowDim", "ProCommand");
	...
	NOTESKIN:LoadActor( Var "Button", "Tap Explosion Bright" ) .. {
		...
		ProW5Command=NOTESKIN:GetMetricA("GhostArrowBright", "ProCommand");
		ProW4Command=NOTESKIN:GetMetricA("GhostArrowBright", "ProCommand");
		ProW3Command=NOTESKIN:GetMetricA("GhostArrowBright", "ProCommand");
		ProW2Command=NOTESKIN:GetMetricA("GhostArrowBright", "ProCommand");
		ProW1Command=NOTESKIN:GetMetricA("GhostArrowBright", "ProCommand");
