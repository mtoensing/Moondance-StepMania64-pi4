	...
	for p = 0,PROFILEMAN:GetNumLocalProfiles()-1 do
		...
		local ProfileCard = Def.ActorFrame {
			Def.BitmapText {
				...
				InitCommand=function(self) self:horizalign(left):shadowlength(1):xy(-120,-12):zoom(1):ztest(true) end;
			...
			Def.Sprite{
				...
				InitCommand=function(self)
					self:setsize(52,52):y(-3):x(110):fadeleft(0.2):faderight(0.1):ztest(true)
				end;
				OffCommand=function(self) self:linear(0.3):diffusealpha(0) end;
			};
		};
...
function LoadCard(cColor)
	local t = Def.ActorFrame {
		Def.Quad {
			...
			OnCommand=function(self) self:linear(0.14):zoomto(270,400) end;
		};
	};
	return t
end
...
--[[ 	local t = LoadActor(THEME:GetPathB('', '_frame 3x3'), 'metal', 200, 230) .. {
	...
	t[#t+1] = Def.ActorFrame {
		...
		Def.BitmapText {
			Font="_Medium";
			InitCommand=function(self) self:shadowlength(1):zoom(1) end;
	...
	t[#t+1] = Def.ActorFrame {
		...
		Def.Quad {
			...
			OnCommand=function(self) self:diffuse(ColorDarkTone(PlayerColor(Player))):diffuserightedge(ColorDarkTone(PlayerCompColor(Player))) end;
		};
		Def.Quad {
