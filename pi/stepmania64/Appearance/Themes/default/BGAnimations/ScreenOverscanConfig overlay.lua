...
local red= color("#F9B18A")
local blue= color("#67E650")
...
local args= {
	...
	valtexact("CenterImageAddHeight", _screen.cx, _screen.cy-56, red),
	valtexact("CenterImageAddWidth", _screen.cx, _screen.cy-25, blue),
	valtexact("CenterImageTranslateX", _screen.cx, _screen.cy+25, blue),
	valtexact("CenterImageTranslateY", _screen.cx, _screen.cy+56, red),
}
